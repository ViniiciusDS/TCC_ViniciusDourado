...
function FB_func = forcabruta_v2(MatrizDistTrab,MatrizTempTrab)

tempoFB = tic;
DistMatriz = MatrizDistTrab;
TempMatriz = MatrizTempTrab;
...
for i = 1:length(Pi)
    ...
    for j = 1:length(rota)   
        ...
        distancia = distancia + DistMatriz(Cidade_partida, Cidade_chegada)/TempMatriz(Cidade_partida,Cidade_chegada);
    end
